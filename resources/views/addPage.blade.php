			...
			<div class="row">
				<div class="col-sm-12 col-lg-12">
					...
					<div class="panel panel-primary">
						...
						<!--<form id='addPageForm' method="POST" action="{{ route('save-page-seo') }}" enctype='multipart/form-data'>-->
						<form id='addPageForm' method="POST" action="{{ route('save-page-seo') }}">
							@csrf	
								...
								<div class="container bg-light p-2">
									<fieldset>
										...
										<div class="col-sm-12 col-md-12 col-lg-12 form-group">
											...
											<label id='seo_meta_title_es'>Title (es)</label>
									...
									<fieldset>
										...
										<div class="col-sm-12 col-md-12 col-lg-12 form-group">
											...
											<input type='text' id='seo_og_image_width' name='seo_og_image_width'
												class='form-control' placeholder='recommended: 1200' /> 
										</div>
										...
										<div class="col-sm-12 col-md-12 col-lg-12 form-group">
											...
											<label for='seo_og_image_height'>Og:Image height</label>
											<input type='text' id='seo_og_image_height' name='seo_og_image_height'
												class='form-control' placeholder='recommended: 630' />
										</div>
										...
										<div class="col-sm-12 col-md-12 col-lg-12 form-group"> 
											...
											<input type='text' id='seo_og_video' name='seo_og_video'
												class='form-control' value="{{ $pageData['seo_og_video'] ?? ''}}" /> 
										</div>
									</fieldset>	
							...
							<div class="panel-footer">
								<div class="form-group">
									...
									<input type='submit' value='Create Page' class='btn btn-primary btn-sm ml-3' />
								</div>		
							</div>		
						</form>
					</div>
